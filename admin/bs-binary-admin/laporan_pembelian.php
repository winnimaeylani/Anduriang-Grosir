	...
	<div class="row">
		...
		<div class="col-md-3">
				...
				<select class="form-control" name="status">
					...
					<option value="sudah kirim bukti pembayaran" <?php echo $status=="sudah kirim bukti pembayaran"?"selected":""; ?>>sudah kirim bukti pembayaran</option>
...
<a href="cetaklaporan.php?tglm=<?php echo $tgl_mulai ?>&tgls=<?php echo $tgl_selesai ?>&status=<?php echo $status ?>" class="btn btn-primary">CETAK</a>