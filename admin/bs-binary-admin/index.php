    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <div class="navbar-brand">Toko Anduriang</div>
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assets/img/AG.png" class="user-image img-responsive"/>
					</li>
				
					
                    <li><a href="index.php"><i class="fa fa-home fa-3x"></i> Home</a></li>
                    <li><a href="index.php?halaman=kategori"><i class="fa fa-tags fa-3x"></i>Kategori Produk</a></li>
                    <li><a href="index.php?halaman=produk"><i class="fa fa-tags fa-3x"></i>Produk</a></li>
                    <li><a href="index.php?halaman=pembelian"><i class="fa fa-shopping-cart fa-3x"></i> Pembelian</a></li>
                    <li><a href="index.php?halaman=laporan_pembelian"><i class="fa fa-folder-open fa-3x"></i> Laporan Pembelian</a></li>
